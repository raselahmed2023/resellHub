    ...
    <div className="min-h-screen grid grid-cols-1 lg:grid-cols-2">
      ...
      <div className="flex flex-col justify-between px-6 py-10 bg-gradient-to-br from-emerald-50 via-white to-teal-50">
        ...
        <div className="w-full max-w-md mx-auto flex flex-col gap-6 py-8">
          ...
          <button onClick={handleGoogleLogin} className="w-full flex items-center justify-center gap-3 border border-gray-200 bg-white hover:bg-gray-50 text-gray-700 font-medium text-sm py-3 rounded-lg transition-colors shadow-sm">
